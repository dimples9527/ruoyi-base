...
public class SysConfigController extends BaseController {
    ...
    @ApiImplicitParam(value = "参数编号", name = "configId", paramType = "path")
    ...
    @ApiImplicitParam(value = "参数键名", name = "configKey", paramType = "path")
    ...
    @ApiImplicitParam(value = "参数主键", name = "configIds", paramType = "path")
